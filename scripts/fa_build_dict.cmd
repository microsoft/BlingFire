...
if ("--type=mph" eq $type) {
  ...
  $command = "".
    "cat $input | ".
    "fa_line2chain_unicode --use-keys --base=16 --key-delim $dir $in_tr_params $tagset $input_enc $ignore_case | ".
    "sort | uniq | ".
    "fa_dict_split --base=16 $mode --out-k2i=$out_k2i --out-i2info=$out_i2info | ".
  ...
  $command = "".
    "cat $input | ".
    "fa_line2chain_unicode --use-keys --key-delim --base=16 --num-size=5 $dir $in_tr_params $tagset $input_enc $ignore_case | ".
    "sort | uniq | ".
